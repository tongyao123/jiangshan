...
public class BaseConfig {
    ...
    public static final String baseTown = "TOM1667025818569";
    //本地测试路径
    public static final String privateKeyPath = "D:\\privateKey\\apiclient_key.pem";
    //服务器路径
//    public static final String privateKeyPath = "/root/privateKey/apiclient_key.pem";
    ...
    public static final String honggutianmerchantId = "1708202737";
    public static final String honggutianAppId = "wxb0a8801e02308219";
    public static final String honggutianmerchantSerialNumber = "762161B6986454DC41CCA8D87296C41F69206053";
    public static final String honggutianapiV3key = "honggutianhonggutianshangcheng19";

    public static final String honggutianaprivateKeyPath = "D:\\privateKey\\honggutian\\apiclient_key.pem";
