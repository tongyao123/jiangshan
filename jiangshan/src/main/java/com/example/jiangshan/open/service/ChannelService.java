...
import com.example.jiangshan.open.client.response.ChannelPageResponse;
import com.example.jiangshan.open.client.response.DevicePageResponse;
import com.example.jiangshan.open.client.response.LiveVideoAddressResponse;
import com.example.jiangshan.open.client.response.LiveVideoOpenResponse;
import com.example.jiangshan.open.constant.ChannelTypeEnum;
import com.example.jiangshan.open.constant.ExceptionEnum;
import com.example.jiangshan.open.domain.DeviceChannelMapper;
